...
12. обработка ошибок должна быть на логировании, а не через панику
- можно написать кастомные типы ошибок
- сделать обертки и т.д.
13. дабавить провоерку статуса ответа
14. баг, дважды написан curFrom
15. вставку в бд можно сделать батчем + транзакция, а не обновлять построчно
16. конфиги для доступа к бд должны лежать в переменных окружения
либо подгружаться из кого то хранилища паролей (vault)
17. подключение и инициализация бд должны быть вынесены
в отдельную сущность
- в идеале какой то singleton для доступа к бд
18. fmt.Println("Connected!") это пишется в логи
19. вставка в бд должна проходить валидацию для защиты от SQL иньекций
